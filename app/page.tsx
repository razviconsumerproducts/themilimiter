...
const modules = [
  ['Dashboard','/'],['Products','/products'],['Inventory','/inventory'],['Sales','/sales'],['Purchasing','/purchasing'],['Manufacturing','/manufacturing'],['MES','/mes'],['Maintenance','/maintenance'],['Quality','/quality'],['Customers','/customers'],['Suppliers','/suppliers'],['Reports','/reports'],['Users & Roles','/users-roles'],['Settings','/settings']
]
