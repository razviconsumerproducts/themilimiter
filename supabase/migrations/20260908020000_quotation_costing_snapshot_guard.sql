...
begin
  ...
  if abs(new.grand_total - coalesce(v_selling_price, 0)) > 0.02 then
...
declare
  ...
  v_item_costing uuid;
begin
  select q.costing_run_id, q.project_id into v_quotation_costing, v_project
